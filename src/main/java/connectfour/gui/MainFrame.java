...
public class MainFrame extends JFrame {
	...
	public void menuGameQuit_actionPerformed(ActionEvent e) throws Exception {
		...
		if ((launcherApp.one.isHuman() && !launcherApp.two.isHuman())
				|| (!launcherApp.one.isHuman() && launcherApp.two.isHuman())) {
		...
		/* nomi dei giocatori */
		writer.println("name1 = \'" + launcherApp.one.getName() + "\';");
